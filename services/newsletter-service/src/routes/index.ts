...
router.post(
  ...
  authMiddleware.requireOwnership(),
  asyncHandler(
    newsletterController.duplicateNewsletter.bind(newsletterController)
  )
);
...
router.get(
  ...
  asyncHandler(
    newsletterController.previewNewsletter.bind(newsletterController)
  )
);
...
router.get(
  ...
  authMiddleware.requireOwnership(),
  asyncHandler(
    newsletterController.getDeliverabilityReport.bind(newsletterController)
  )
);
...
router.post(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.createItem.bind(contentLibraryController)
  )
);
...
router.put(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.updateItem.bind(contentLibraryController)
  )
);
...
router.delete(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.deleteItem.bind(contentLibraryController)
  )
);
...
router.post(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.duplicateItem.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.searchContent.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getAllTags.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getAllCategories.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getItemsByTags.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getItemsByCategory.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getPendingApprovalItems.bind(
...
router.post(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.approveItem.bind(contentLibraryController)
  )
);
...
router.post(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.rejectItem.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getApprovalWorkflow.bind(contentLibraryController)
  )
);
...
router.post(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.submitApproval.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getPendingApprovals.bind(contentLibraryController)
  )
);
...
router.post(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.createBlock.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getBlocks.bind(contentLibraryController)
  )
);
...
router.put(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.updateBlock.bind(contentLibraryController)
  )
);
...
router.delete(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.deleteBlock.bind(contentLibraryController)
  )
);
...
router.post(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.duplicateBlock.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getReusableBlocks.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getBlocksByCategory.bind(contentLibraryController)
  )
);
...
router.post(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.renderBlock.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getBlockCategories.bind(contentLibraryController)
  )
);
...
router.post(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.trackContentPerformance.bind(
      contentLibraryController
    )
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getContentAnalytics.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getContentPerformanceReport.bind(
      contentLibraryController
    )
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getTopPerformingContent.bind(
      contentLibraryController
    )
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getContentAnalyticsSummary.bind(
      contentLibraryController
    )
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getContentStats.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getBlockStats.bind(contentLibraryController)
  )
);
...
router.get(
  ...
  authMiddleware.authenticate,
  asyncHandler(
    contentLibraryController.getWorkflowStats.bind(contentLibraryController)
  )
);
