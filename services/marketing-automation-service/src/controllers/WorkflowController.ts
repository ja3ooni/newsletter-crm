...
export class WorkflowController {
  ...
  async createWorkflow(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('Error in createWorkflow controller', {
        error,
        body: req.body,
      });
      res.status(500).json({
  ...
  async getWorkflow(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('Error in getWorkflow controller', {
        error,
  ...
  async getWorkflows(req: Request, res: Response): Promise<void> {
    try {
      ...
      logger.error('Error in getWorkflows controller', {
        error,
        query: req.query,
      });
      res.status(500).json({
  ...
  async getWorkflowExecution(req: Request, res: Response): Promise<void> {
    try {
      ...
      const execution =
        await this.workflowService.getWorkflowExecution(executionId);
  ...
  async getWorkflowExecutions(req: Request, res: Response): Promise<void> {
    try {
      ...
      const result = await this.workflowService.getWorkflowExecutions(
        id,
        pagination
      );
